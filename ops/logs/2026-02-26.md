...
## Next Action
1. Extend `web/scripts/funnel-rollup.mjs` with post-waitlist founder upsell source splits (`hero-post-waitlist-*`, `footer-post-waitlist-*`) and waitlist->founder upgrade rate.
