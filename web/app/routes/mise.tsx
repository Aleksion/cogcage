...
export const Route = createFileRoute('/mise')({
  ...
  head: () => ({
    meta: [
      { title: 'The Molt Pit — The Mise' },
      {
        name: 'description',
        content: 'Build your loadout. Tune claws, armor, and directives before your next molt.',
      },
    ],
  }),
  component: ShellPage,
      ...
      <>
        ...
        <div className="shell-gate">
          ...
          <p className="shell-gate-sub">
            Descend to prepare your active molt and bring your crustie into the pit.
          </p>
...
function ShellPage() {
  const { returnTo } = useSearch({ from: '/mise' })
